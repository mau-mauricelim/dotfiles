...
##
## PERF: Leave the defaults commented and add any overrides below uncommented
##
...
# config.bind('[[', 'navigate prev') # page 2 to 1
...
# config.bind('yy', 'yank')
# config.bind('{{', 'navigate prev --tab')
# config.bind('}}', 'navigate next --tab')
