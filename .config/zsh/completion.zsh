...
zstyle ':fzf-tab:complete:*' fzf-preview "${FZF_PREVIEW_FILE_OR_DIR//\{\}/\$realpath}"
# Preview directory's content with eza when completing cd
zstyle ':fzf-tab:complete:cd:*' fzf-preview "${FZF_PREVIEW_DIR//\{\}/\$realpath}"
# Custom fzf flags
