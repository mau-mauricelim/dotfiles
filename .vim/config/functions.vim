...
vnoremap <Leader>\V :call ToggleVirtualEdit()<CR>
...
nnoremap <Leader>\p :call ToggleClipboard()<CR>
vnoremap <Leader>\p :call ToggleClipboard()<CR>
...
vnoremap <Leader>\s :call ToggleSigncolumn()<CR>
